...
function addToBid(amount) {
  const currentBid = Number.parseInt(bidAmount.value) || gameStore.auctionItem.currentBid
  bidAmount.value = (currentBid + amount).toString()
}

const canBid = computed(() => {
  const amount = Number.parseInt(bidAmount.value)
    ...
    <div class="p-4">
      ...
      <div class="mb-6">
        ...
        <p class="text-gray-600">
          Đấu giá để sở hữu vật phẩm hiếm
        </p>
      </div>
