<template>
  <div class="p-4 pb-20">
    <!-- Header -->
    <div class="mb-6">
      <h1 class="text-2xl font-bold text-gray-900 mb-2">Mảnh Dữ Liệu</h1>
      <p class="text-gray-600">Các manh mối để giải câu đố cuối cùng</p>
    </div>
    ...
    <UCard class="mb-6">
      <div class="text-center">
        ...
        <p class="text-sm text-gray-600 mb-3">Mảnh dữ liệu đã thu thập</p>
        ...
        <UCard>
          <div class="flex space-x-4">
            ...
            <div class="flex-1 min-w-0">
              <h3 class="font-semibold text-gray-900 mb-1">{{ hint.title }}</h3>
              <p class="text-sm text-gray-600">{{ hint.description }}</p>
            </div>
          </div>
        </UCard>
      </div>
      ...
      >
        <UCard class="opacity-50">
          <div class="flex space-x-4">
            ...
            <!-- Content -->
            <div class="flex-1 min-w-0">
              <h3 class="font-semibold text-gray-400 mb-1">Mảnh dữ liệu bí ẩn</h3>
              <p class="text-sm text-gray-400">Chưa được khám phá...</p>
            </div>
          </div>
        </UCard>
      </div>
