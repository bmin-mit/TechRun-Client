<template>
  <div class="p-4 pb-20">
    <!-- Header -->
    <div class="mb-6">
      <h1 class="text-2xl font-bold text-gray-900 mb-2">Bản Đồ Trạm</h1>
    ...
    <UCard class="mb-6">
      <div class="text-center">
        <div class="flex items-center justify-center space-x-4 mb-3">
          <div class="text-center">
            <p class="text-2xl font-bold text-green-600">{{ gameStore.visitedStations.length }}</p>
            <p class="text-xs text-gray-600">Đã ghé</p>
          </div>
          <div class="w-px h-8 bg-gray-300"></div>
          <div class="text-center">
            <p class="text-2xl font-bold text-blue-600">1</p>
            <p class="text-xs text-gray-600">Hiện tại</p>
          </div>
          <div class="w-px h-8 bg-gray-300"></div>
          <div class="text-center">
            <p class="text-2xl font-bold text-gray-400">{{ gameStore.stations.length - gameStore.visitedStations.length - 1 }}</p>
            <p class="text-xs text-gray-600">Chưa ghé</p>
          </div>
        </div>
        <UProgress 
    ...
    <UCard class="mt-4" v-if="gameStore.currentStation">
      <UAlert 
